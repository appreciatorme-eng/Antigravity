...
| H-05 | Admin brute-force — telemetry only | `src/lib/auth/admin.ts:120–150` | Add `enforceRateLimit` in password-login handler before Supabase auth call | Login attempts limited to 10 per 5 min | ⏳ |
...
## Test Suite Status
- Vitest: pending
- Playwright E2E: `e2e/tests/remediation-s40.spec.ts` — pending

## Commit Log
| Phase | Commit | Date | Summary |
|-------|--------|------|---------|
| Tracker | — | 2026-03-16 | chore: create remediation tracker s40 |
