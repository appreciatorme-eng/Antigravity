...
export function SolutionsContent({ type }: { type: string }) {
  const data = solutionsData[type] ?? solutionsData.solo;
          ...
          <div className="px-6 md:px-24 max-w-7xl mx-auto relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {data.benefits.map((benefit) => (
                <div key={benefit} className="flex items-start gap-4 p-8 rounded-3xl bg-black border border-white/10">
