...
// Preview approximation of the server-side Sharp compositor output.
...
export const LayoutRenderer = ({ layout, data }: LayoutRendererProps) => {
    ...
    switch (layout) {
        ...
        case "WaveDivider":        return <WaveDividerLayout templateData={data} preset={props.preset} />;
        case "CircleAccent":       return <CircleAccentLayout templateData={data} preset={props.preset} />;
        case "FloatingCard":       return <FloatingCardLayout templateData={data} preset={props.preset} />;
        case "PremiumCollage":     return <PremiumCollageLayout templateData={data} preset={props.preset} />;
        case "BannerRibbon":       return <BannerRibbonLayout templateData={data} preset={props.preset} />;
        case "SplitWave":          return <SplitWaveLayout templateData={data} preset={props.preset} />;
