...
const routes = createCatchAllHandlers([
  ...
  ["queue-status", () => import("@/app/api/_handlers/social/queue-status/route")],
  ["queue-retry", () => import("@/app/api/_handlers/social/queue-retry/route")],
  ["calendar", () => import("@/app/api/_handlers/social/calendar/route")],
