...
- [x] Update `app_theme.dart` with Stitch colors
- [x] Add Cormorant Garamond font to pubspec.yaml
- [x] Create glassmorphism card widgets
- [x] Add background gradient

### Auth Portal

- [x] Update role toggle animation
- [x] Implement input underline animation
- [x] Add Begin Journey button with icon
- [x] Update background gradient

### Traveler Dashboard

- [x] Create sticky glass header
- [x] Add status pill with pulsing dot
- [x] Update driver card layout
- [x] Implement Up Next card with large time
- [x] Create quick actions grid (2x2)
- [x] Add bottom navigation

### Driver Command

- [x] Add driver ID badge
- [x] Implement ON DUTY toggle
- [x] Create current job card
- [x] Add Start Navigation button
- [x] Create upcoming routes list
- [x] Add vehicle status card

### Itinerary Timeline

- [x] Create horizontal date selector
- [x] Implement timeline cards
- [x] Add time badges
- [x] Create image preview layout
- [x] Add status pills
