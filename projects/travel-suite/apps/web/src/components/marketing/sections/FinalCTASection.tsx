...
import { GradientMesh, MagneticButton } from "@/components/marketing/effects";

export function FinalCTASection() {
  return (
    <section className="relative z-30 py-24 md:py-40 bg-transparent text-center px-6 md:px-10 border-t border-white/10 mt-20 overflow-hidden">
      <GradientMesh colors={["#FF9933", "#00F0FF", "#0A0A0F"]} className="opacity-30" />
      <div className="absolute top-0 inset-x-0 h-px bg-gradient-to-r from-transparent via-[#FF9933]/50 to-transparent"></div>
      <div className="relative max-w-4xl mx-auto space-y-10 reveal-text">
