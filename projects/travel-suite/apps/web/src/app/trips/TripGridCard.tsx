...
export function TripGridCard({ trip, onDelete, deleting = false }: TripGridCardProps) {
    ...
    const handleDownloadPdf = async (event: MouseEvent<HTMLButtonElement>) => {
        ...
        try {
            await downloadTripItineraryPdf({ tripId: trip.id });
    ...
    return (
        ...
        >
            <div className="relative h-52 overflow-hidden">
                ...
                <div className="relative flex h-full flex-col justify-between p-5">
                    ...
                    <div className="space-y-3">
                        ...
                        <div>
                            <h3 className="max-w-[95%] text-[1.6rem] font-semibold leading-tight tracking-tight text-white md:max-w-[90%] md:text-2xl">
            ...
            <div className="space-y-5 px-5 pb-5 pt-4">
                ...
                <div className="rounded-[24px] border border-white/8 bg-white/[0.03] p-4">
                    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                        ...
                        <button
                            ...
                            className="inline-flex w-full items-center justify-center gap-2 rounded-full border border-emerald-400/25 bg-emerald-500/12 px-4 py-2.5 text-[11px] font-semibold text-emerald-200 transition hover:bg-emerald-500/20 disabled:cursor-not-allowed disabled:opacity-60 sm:w-auto"
                ...
                <div className="flex flex-col gap-2 px-1 text-[11px] font-medium text-white/45 sm:flex-row sm:items-center sm:justify-between">
