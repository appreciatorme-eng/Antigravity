...
async function githubRequest<T>(
    ...
    const res = await fetch(url, {
        // eslint-disable-next-line no-restricted-syntax -- GitHub REST API requires Bearer token
        ...options,
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any -- error_events/error_patterns not in generated types
type AdminClient = ReturnType<typeof createAdminClient> extends infer T ? any : any;
