...
DO $$
DECLARE
  v_demo_org uuid := '00000000-demo-0000-0000-000000000001';
  -- Admin profile
  v_admin    uuid := '00000000-demo-0000-0000-adm000000001';
  -- Client profiles
  v_c1  uuid := '00000000-demo-0000-0000-cli000000001';
  v_c2  uuid := '00000000-demo-0000-0000-cli000000002';
  v_c3  uuid := '00000000-demo-0000-0000-cli000000003';
  v_c4  uuid := '00000000-demo-0000-0000-cli000000004';
  v_c5  uuid := '00000000-demo-0000-0000-cli000000005';
  v_c6  uuid := '00000000-demo-0000-0000-cli000000006';
  v_c7  uuid := '00000000-demo-0000-0000-cli000000007';
  v_c8  uuid := '00000000-demo-0000-0000-cli000000008';
  v_c9  uuid := '00000000-demo-0000-0000-cli000000009';
  v_c10 uuid := '00000000-demo-0000-0000-cli000000010';
  v_c11 uuid := '00000000-demo-0000-0000-cli000000011';
  v_c12 uuid := '00000000-demo-0000-0000-cli000000012';
  -- Driver profiles
  v_d1  uuid := '00000000-demo-0000-0000-drv000000001';
  v_d2  uuid := '00000000-demo-0000-0000-drv000000002';
  v_d3  uuid := '00000000-demo-0000-0000-drv000000003';
  v_d4  uuid := '00000000-demo-0000-0000-drv000000004';
  -- Trip IDs
  v_t1  uuid := '00000000-demo-0000-0000-tri000000001';
  v_t2  uuid := '00000000-demo-0000-0000-tri000000002';
  v_t3  uuid := '00000000-demo-0000-0000-tri000000003';
  v_t4  uuid := '00000000-demo-0000-0000-tri000000004';
  v_t5  uuid := '00000000-demo-0000-0000-tri000000005';
  v_t6  uuid := '00000000-demo-0000-0000-tri000000006';
  v_t7  uuid := '00000000-demo-0000-0000-tri000000007';
  v_t8  uuid := '00000000-demo-0000-0000-tri000000008';
  v_t9  uuid := '00000000-demo-0000-0000-tri000000009';
  v_t10 uuid := '00000000-demo-0000-0000-tri000000010';
  -- Itinerary IDs
  v_i1  uuid := '00000000-demo-0000-0000-itn000000001';
  v_i2  uuid := '00000000-demo-0000-0000-itn000000002';
  v_i3  uuid := '00000000-demo-0000-0000-itn000000003';
  v_i4  uuid := '00000000-demo-0000-0000-itn000000004';
  v_i5  uuid := '00000000-demo-0000-0000-itn000000005';
  v_i6  uuid := '00000000-demo-0000-0000-itn000000006';
  v_i7  uuid := '00000000-demo-0000-0000-itn000000007';
  v_i8  uuid := '00000000-demo-0000-0000-itn000000008';
  v_i9  uuid := '00000000-demo-0000-0000-itn000000009';
  v_i10 uuid := '00000000-demo-0000-0000-itn000000010';
BEGIN
