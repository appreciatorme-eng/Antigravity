...
const faqs = [
    {
        question: "Do I need to be a technical expert to use TripBuilt?",
        answer: "Not at all. TripBuilt is designed specifically for travel professionals, not developers. Our intuitive drag-and-drop interface means you can start building beautiful itineraries on day one, without writing a single line of code."
    },
    {
        question: "Does TripBuilt integrate with my existing GDS?",
    ...
    },
    {
        ...
        answer: "No. All TripBuilt plans include unlimited proposal generation, unlimited client portals, and unlimited invoice creation."
    }
];
