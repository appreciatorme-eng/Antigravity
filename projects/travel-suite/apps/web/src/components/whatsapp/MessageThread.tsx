...
export function MessageThread({
  ...
  if (!conversation) {
    return (
      <div className="flex-1 hidden md:flex flex-col items-center justify-center gap-4 bg-white/2">
      ...
      >
        <div className="flex items-center gap-2 md:gap-3 min-w-0">
          ...
          {onBack && (
            <button
              onClick={onBack}
              className="md:hidden w-8 h-8 rounded-full hover:bg-white/10 flex items-center justify-center transition-colors shrink-0"
        ...
        <div className="flex items-center gap-0.5 md:gap-1 shrink-0">
          ...
          <button
            ...
            className={`hidden sm:flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold transition-colors active:scale-95 ${
              isEmail
