...
export const DEMO_ITINERARY_IDS = [
...
export function buildTrips() {
  const [c1, c2, c3, c4, c5, c6, c7, c8] = DEMO_CLIENT_IDS;
  const [i1, i2, i3, i4, i5, i6, i7, i8, i9, i10] = DEMO_ITINERARY_IDS;
...
export function buildServiceCosts() {
  const [t1, t2, t3, t4, t5, t6, t7, t8, t9, t10] = DEMO_TRIP_IDS;
  return [
...
export function buildOverheadExpenses() {
  return [
...
export function buildExternalDrivers() {
  return [
    { id: uuid(), organization_id: DEMO_ORG_ID, name: "Raju Singh",   phone: "+919800000001", vehicle_type: "suv",     vehicle_number: "MH-02-AB-1234", created_at: "2025-12-10T00:00:00Z" },
    { id: uuid(), organization_id: DEMO_ORG_ID, name: "Suresh Kumar", phone: "+919800000002", vehicle_type: "minibus", vehicle_number: "MH-04-CD-5678", created_at: "2025-12-10T00:00:00Z" },
    { id: uuid(), organization_id: DEMO_ORG_ID, name: "Mohan Yadav",  phone: "+919800000003", vehicle_type: "suv",     vehicle_number: "MH-01-EF-9012", created_at: "2025-12-10T00:00:00Z" },
    { id: uuid(), organization_id: DEMO_ORG_ID, name: "Kiran Patil",  phone: "+919800000004", vehicle_type: "sedan",   vehicle_number: "MH-03-GH-3456", created_at: "2025-12-10T00:00:00Z" },
  ];
}
