        ...
        <section className="relative z-30 py-24 px-6 md:px-24 border-t border-white/5 bg-[#050505] overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto">
                <div className="text-center mb-16 relative z-10">
                    <h2 className="text-3xl md:text-5xl font-bold mb-4">Why operators switch to <span className="text-[#00F0FF]">TravelSuite</span></h2>
                ...
                >
                    ...
                    <div className="grid grid-cols-3 p-6 border-b border-white/10 bg-white/[0.02]">
                        ...
                        <div className="font-bold text-[#00F0FF] text-center">TravelSuite</div>
