    ...
    <Document>
        <Page size="A4" style={styles.page}>
            <View style={styles.header}>
                ...
                <Text style={{ fontSize: 10, color: '#00d084', marginBottom: 5 }}>GoBuddy TravelSuite</Text>
                ...
                <View key={day.day_number} style={styles.dayContainer}>
                    ...
                    {day.activities.map((act, idx) => (
                        <View key={idx} style={styles.activity}>
                            ...
                            <Text style={styles.location}>📍 {act.location}</Text>
            ...
            <Text style={styles.footer} render={({ pageNumber, totalPages }) => (
                `Generated by AI Trip Planner - Page ${pageNumber} of ${totalPages}`
            )} fixed />
        </Page>
    </Document>
);
