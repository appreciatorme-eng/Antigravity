...
export default defineConfig({
  ...
  webServer: {
    command:
      ...
      `cd "${appDir}" && CRON_SECRET="${testCronSecret}" PUBLIC_PROPOSAL_ACTION_RATE_LIMIT_MAX="1" PUBLIC_SHARE_WRITE_RATE_LIMIT_MAX="1" PUBLIC_SHARE_READ_RATE_LIMIT_MAX="1" /opt/homebrew/opt/node@22/bin/npx next dev --webpack --port 3100`,
    url: publicBaseUrl,
