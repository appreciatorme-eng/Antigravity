...
const cspHeader = [
  ...
  "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://app.posthog.com https://us.i.posthog.com https://us-assets.i.posthog.com https://*.sentry.io https://*.ingest.sentry.io https://maps.googleapis.com https://maps.gstatic.com https://prod.spline.design https://*.tile.openstreetmap.org https://*.openstreetmap.org https://tiles.openfreemap.org",
